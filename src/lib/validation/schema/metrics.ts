...
/** HistogramDataPoint */
const histogramDataPointSchema = z
  .object({
    attributes: z.array(keyValueSchema).optional(),
    startTimeUnixNano: timestampSchema.optional(),
    timeUnixNano: timestampSchema.optional(),
...
const exponentialHistogramDataPointSchema = z
  .object({
    attributes: z.array(keyValueSchema).optional(),
    startTimeUnixNano: timestampSchema.optional(),
    timeUnixNano: timestampSchema.optional(),
...
/** SummaryDataPoint */
const summaryDataPointSchema = z
  .object({
    attributes: z.array(keyValueSchema).optional(),
    startTimeUnixNano: timestampSchema.optional(),
    timeUnixNano: timestampSchema.optional(),
...
const sumSchema = z
  .object({
    ...
    aggregationTemporality: z
      ...
      .max(2, {
        message:
          "aggregationTemporality must be <= 2 (UNSPECIFIED=0, DELTA=1, CUMULATIVE=2)",
      })
      .optional(),
    isMonotonic: z
      .boolean({
...
const exponentialHistogramSchema = z
  .object({
